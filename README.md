...
SPD-2: Revenue and Profitability Insights (Core Setup & DAX).

SPD-3: Trend and Time Intelligence Analysis (Calendar & YoY).

SPD-4: Product and Regional Deep-dive (Mapping & Advanced Filters).
